                ...
                <div class="flex flex-col w-full">
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT Teachers.TeacherID, Teachers.NIP, Teachers.AcademicDegree, Teachers.EducationLevel, Teachers.EmploymentStatus, Users.FullName 
                        FROM Teachers 
                        INNER JOIN Users ON Teachers.UserID = Users.UserID 
                        WHERE Teachers.NIP LIKE '%$searchTerm%' 
                        OR Teachers.AcademicDegree LIKE '%$searchTerm%' 
                        OR Teachers.EducationLevel LIKE '%$searchTerm%' 
                        OR Teachers.EmploymentStatus LIKE '%$searchTerm%' 
    ...
    function confirmDelete(teacherID) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = `manage_teachers_delete.php?id=${teacherID}`;
            }
        });
    }
</script>
