<div class="bg-white rounded p-4 shadow-md mb-4">
    ...
    <h2 class="text-2xl font-semibold mb-2">B. Tujuan Cisco Packet Tracer</h2>

    <p class="mb-4">Tujuan utama dari Cisco Packet Tracer adalah menyediakan alat yang efektif bagi siswa dan pengajar agar dapat memahami prinsip dasar jaringan komputer. Aplikasi ini juga bertujuan untuk membantu pengguna membangun keterampilan praktis dalam menggunakan alat-alat jaringan Cisco.</p>

    <p class="mb-4">Cisco Packet Tracer sering digunakan sebagai sarana pembelajaran dalam konteks Cisco Networking Academy, terutama untuk persiapan sertifikasi Cisco Certified Network Associate (CCNA). Melalui penggunaan aplikasi ini, siswa dapat menguji dan memperdalam pemahaman mereka tentang konsep jaringan dan konfigurasi perangkat Cisco.</p>
