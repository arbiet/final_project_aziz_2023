          ...
          <table class="min-w-full">
            <thead>
              <tr>
                ...
                <th class="text-left py-2">Student Number</th>
                <th class="text-left py-2">Full Name</th>
                <th class="text-left py-2">Phone Number</th>
                <th class="text-left py-2">Email</th>
                <th class="text-left py-2">Class</th> <!-- Add this column for Class -->
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td class="py-2"><?php echo $row['ClassName']; ?></td> <!-- Add this column for Class -->
                  <td class='py-2'>
