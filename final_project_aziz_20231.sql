...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Mar 2024 pada 13.11
...
--
-- Struktur dari tabel `AssignmentAttachments`
--
...
--
-- Dumping data untuk tabel `AssignmentAttachments`
--
...
--
-- Struktur dari tabel `AssignmentSubmissions`
--
...
--
-- Dumping data untuk tabel `AssignmentSubmissions`
--
...
(3, 1, 5, 'asdas', '../static/image/submission/1711005492_e42cc5c9e1.docx', '2024-03-21 07:18:12', NULL, NULL, NULL),
...
--
-- Struktur dari tabel `ClassSubjects`
--
...
--
-- Dumping data untuk tabel `ClassSubjects`
--
...
--
-- Struktur dari tabel `StudentResponses`
--
...
--
-- Struktur dari tabel `TestResults`
--
...
--
-- Dumping data untuk tabel `TestResults`
--
...
(17, 'test', 'Pretest', NULL, NULL, 14, NULL);
...
(137648118, 'admin', 'ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f', 'admin@ikimukti.com', 'Administrator', NULL, NULL, NULL, NULL, 1, '2024-03-25 12:08:52', '2024-03-25 19:08:52', NULL, 'default.png', 'active'),
(1699007959, 'aziz', 'ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f', 'wahyuadi@gmail.com', 'Muhammad As’adul Azis Wahyuadi ', '2023-11-22', 'Male', 'Tuban', '+62 896-8736-8865', 2, '2024-03-21 07:18:39', '2024-03-21 14:18:39', 'active', NULL, 'active'),
...
(1705540077, 'abi_satria', 'ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f', 'abi.satria@example.com', 'Abi Satria', '2005-01-01', 'Male', 'Kediri', '08123456789', 3, '2024-03-23 14:30:27', '2024-03-23 21:30:27', 'Active', 'default.png', 'active'),
...
--
-- Indeks untuk tabel `AssignmentAttachments`
--
...
--
-- Indeks untuk tabel `AssignmentSubmissions`
--
...
--
-- Indeks untuk tabel `ClassSubjects`
--
...
--
-- Indeks untuk tabel `StudentResponses`
--
...
--
-- Indeks untuk tabel `TestResults`
--
...
--
-- AUTO_INCREMENT untuk tabel `AssignmentAttachments`
--
ALTER TABLE `AssignmentAttachments`
...
--
-- AUTO_INCREMENT untuk tabel `AssignmentSubmissions`
--
ALTER TABLE `AssignmentSubmissions`
...
--
-- AUTO_INCREMENT untuk tabel `ClassSubjects`
--
ALTER TABLE `ClassSubjects`
...
--
-- AUTO_INCREMENT untuk tabel `StudentResponses`
--
ALTER TABLE `StudentResponses`
...
--
-- AUTO_INCREMENT untuk tabel `TestResults`
--
ALTER TABLE `TestResults`
...
--
-- Ketidakleluasaan untuk tabel `AssignmentAttachments`
--
ALTER TABLE `AssignmentAttachments`
...
--
-- Ketidakleluasaan untuk tabel `AssignmentSubmissions`
--
ALTER TABLE `AssignmentSubmissions`
...
--
-- Ketidakleluasaan untuk tabel `ClassSubjects`
--
ALTER TABLE `ClassSubjects`
